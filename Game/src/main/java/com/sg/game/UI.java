...
public class UI {
   ...
   while (doYouWantToPlay) {
       ...
       System.out.println("Welcome to Tic Tac Toe. I am your fair but fierce opponent! \n"
               + " before we start (and I win) you must chose the what letter \n"
               + " each of us will play as. That's right, we can be more than just x's and 0's! ");
       System.out.println();
